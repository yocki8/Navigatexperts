...
const Showbus = ({ source, destination }) => {
    console.log("hue:",source, destination);

    const [selectedValue, setSelectedValue] = useState(null);

    const handleButtonClick = (value) => {
        setSelectedValue(value);
        <Gmaps selectedValue={selectedValue}/>
    };
        ...
        <div className="bus-sub-cont">
            ...
            <div className="bus-card">
                ...
                <div className='bus-right-item'>
                    <Link to='/track'>
                        <button className="bus-track" onClick={() => handleButtonClick('Value 1')}>Track</button>
                    </Link>
                </div>
            ...
            <div className="bus-card">
                ...
                <div className='bus-right-item'>
                    <Link to='/track'>
                        <button className="bus-track" onClick={() => handleButtonClick('Value 2')}>Track</button>
                    </Link>
                </div>
            ...
            <div className="bus-card">
                ...
                <div className='bus-right-item'>
                    <Link to='/track'>
                        <button className="bus-track" onClick={() => handleButtonClick('Value 3')}>Track</button>
                    </Link>
                </div>

            </div>
        </div>
        {/* Pass the selectedValue as a prop to AnotherComponent */}
        {/* <Gmaps selectedValue={selectedValue} /> */}
    </div>
  )
}
